...
(function () {
  ...
  function V(a, b) {
    ...
    E
      ...
      : ((n = n ? W(n, u) : Math.max(u / 2, C) | 0), (q = q ? W(q, v) : Math.max(v / 2, D) | 0));
    Y = Y ? W(Y, e, n) : N;
    Z = Z ? W(Z, t, q) : M;
    this.x = Y;
    this.y = Z;
  ...
  function ha() {
    ...
    fa =
      L &&
      L.replace('request', 'exit').replace('mozRequest', 'mozCancel').replace('Request', 'Exit');
  ...
  function la() {
    ...
    for (var g, l; e < a; e++)
      (d = x[e]),
        ...
        d.resize((l + 1) | 0, d.h, !0).move((d.left + b[g] * l) | 0, Q - d.bottom - d.h, !0),
        b[g]++;
  }
  function X(a, b) {
    function c(h) {
    ...
    function e(h) {
      ...
      H &&
        ((a.width = Math.max(Math.min(a.width, a.l, P - a.x - a.right), a.o)), (H = a.width !== C));
      I &&
        ((a.height = Math.max(Math.min(a.height, a.j, Q - a.y - a.bottom), a.m)),
        (I = a.height !== D));
      (H || I) && a.resize();
  ...
  f.blur = function (a) {
    ...
    K === this &&
      (this.removeClass('focus'), (this.focused = !1), this.onblur && this.onblur(), (K = null));
    return this;
  };
  f.hide = function (a) {
  ...
  f.fullscreen = function (a) {
    ...
    if (!J || !za())
      this.body[L](), (J = this), (this.full = !0), this.onfullscreen && this.onfullscreen();
