export const arrowUp = `<g width="16" height="16" stroke="currentColor" stroke-width="1.5">
...
export const arrowDown = `<g width="16" height="16" stroke="currentColor" stroke-width="1.5">
  <rect width="16" height="16" fill="transparent" stroke="none" />
